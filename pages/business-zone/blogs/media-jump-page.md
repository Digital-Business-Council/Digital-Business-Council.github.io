...
<div class="media-zone-cardstack-header">
  ...
  {% for blog-page in site.categories.blog %}
	...
	<div class="card-title">
    		<a href="{{ blog-page.url | absolute_url }}">{{ blog-page.title | truncate: 110}}</a>
    	</div>
	...
	<div class="card-content">
    		<img src="{{ blog-page.excerpt-image | absolute_url }}" /> {{ blog-page.excerpt | truncate: 250, "..  [Continue reading...]{{ blog-page.url | absolute_url }}"}}
    	</div>
