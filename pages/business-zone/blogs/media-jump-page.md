...
<div class="media-zone-cardstack-header">
  ...
  {% for blog-page in site.categories.blog  limit:2 %}
	...
	<div class="card-title">
    		<a href="{{ blog-page.url | absolute_url }}">{{ blog-page.title | truncate: 70}}</a>
    	</div>
	...
	<div class="card-social">    
		...
		<td width="25px" padding="0px">
    		...
    		<td width="25px" padding="0px">
    			<a href="http://www.linkedin.com/shareArticle?mini=true&summary={{ blog-page.excerpt | strip_html}}&title={{ blog-page.title }}&url={{ blog-page.url | absolute_url }}"><img src="{{site.url}}/images/favicon/linkedin.jpg" width="20px" class="social-img" /></a>
    		</td>
    		<td width="25px" padding="0px">
...
<div class="media-zone-cardstack-header">
  ...
  {% for blog-page in site.categories.case-study  limit:2 %}
	...
	<div class="card-content">
    		<img src="{{ blog-page.excerpt-image | absolute_url }}" /> {{ blog-page.excerpt | truncate: 225 }}
    	</div>
